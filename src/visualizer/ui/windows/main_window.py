...
class MainWindow(QMainWindow):
    ...
    def create_left_panel(self) -> QWidget:
        ...
        controls_title.setStyleSheet("color: #1976D2; border-bottom: 1px solid #1976D2; padding-bottom: 2px;")
        ...
        self.load_button.setStyleSheet("QPushButton { padding: 4px; font-size: 10px; }")
        ...
        self.axis_x_spin.setMaximumHeight(20)
        ...
        self.axis_y_spin.setMaximumHeight(20)
        ...
        self.axis_z_spin.setMaximumHeight(20)
        ...
        self.angle_spin.setMaximumHeight(20)
        ...
        info_title.setStyleSheet("color: #1976D2; border-bottom: 1px solid #1976D2; padding-bottom: 2px; margin-top: 4px;")
